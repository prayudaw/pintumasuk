...
<html lang="en" data-bs-theme="auto">
  <head><script src="<?php echo base_url('assets/dashboard/js/color-modes.js') ?>"></script>
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Pintu Masuk</a>
